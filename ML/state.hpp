...
public:
    // Constructor
    DetOneCarPolicy(float max_speed_straight_ = 1450., float max_speed_curve_ = 1250.,  float accel_ = 5000., int straight_lane_ = 2, int curve_lane_ = 1, float laneoffset_ = 1000., float curve_threshold_ = 0.5) {
