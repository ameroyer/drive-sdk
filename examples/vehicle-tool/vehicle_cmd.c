...
// Global variables used by main.c
int vehicle_start = 0; //True iff the main event loop is set up
int vehicle_connected = 0; //True iff the vehicle is connected
...
int interactive_from_file(const char *src, const char *dst,
			  const char *dst_type, int psm, char* pipe)
{
  guint input;
  guint signal;
